...
public class ApiManage {
    ...
    public SchoolApi getSchoolService()
    {
        if (this.schoolApi == null);
        synchronized (this.zhihuMonitor)
        {
            if (this.schoolApi == null)
                this.schoolApi = ((SchoolApi)new Retrofit.Builder().baseUrl("http://vkako.com/").addCallAdapterFactory(RxJavaCallAdapterFactory.create()).client(client).addConverterFactory(GsonConverterFactory.create()).build().create(SchoolApi.class));
