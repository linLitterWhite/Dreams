...
public class CollectForumFragment extends BaseFragment
{
	...
	private void initView(){  this.schoolSwiper.setColorSchemeColors(new int[]{Color.RED,Color.BLUE,Color.GREEN});
	...
	public void respond(String result){
		...
		if(forums.size()<1){
			Toast.makeText(getContext(),"您还没有收藏的帖子，快去收藏吧！",Toast.LENGTH_SHORT).show();
		}
	...
	map.put("user_id", SharePreferenceUtil.getUserInfo(getContext(),"id"));
